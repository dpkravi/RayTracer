...
Box combineBoxes( Box leftBox, Box rightBox) {
  ...
  if (leftBox.maxPt.y > rightBox.maxPt[1]) {
    b.maxPt.y = leftBox.maxPt[1];
  }
  else {
    b.maxPt.y = rightBox.maxPt[1];
  }
  
  if (leftBox.maxPt.z > rightBox.maxPt[2]) {
    b.maxPt.z = leftBox.maxPt[2];
  } 
  else {
    b.maxPt.z = rightBox.maxPt[2];
  }
